...
import net.cyndeline.scalarlib.rlgraph.regularEdgeLabeling.{RegularEdgeLabeling, EdgeLabeling, RELFactory}
import scala.reflect.runtime.universe.TypeTag
import scala.reflect.ClassTag
import net.cyndeline.scalarlib.rlgraph.embedding.{AdjacencyEntry, Embedding}
import scala.collection.mutable.ListBuffer
import net.cyndeline.scalarlib.rlgraph.util.{IndexGraph, GraphConverter, GraphCommons}
import net.cyndeline.scalarlib.rlgraph.util.{ IndexVertex => IV }
import net.cyndeline.scalarlib.rlgraph.regularEdgeLabeling.factories.help.{OuterEdgeAppender, OuterCycle}
