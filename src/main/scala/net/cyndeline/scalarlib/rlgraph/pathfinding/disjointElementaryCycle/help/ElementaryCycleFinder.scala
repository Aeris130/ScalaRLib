package net.cyndeline.scalarlib.rlgraph.pathfinding.disjointElementaryCycle.help

import scalax.collection.GraphEdge.UnDiEdge
import scalax.collection.immutable.Graph
import net.cyndeline.scalarlib.rlgraph.util.{GraphConverter, GraphConverterI, DeadEndTrimmer}
import scala.collection.mutable
import scala.reflect.runtime.universe.TypeTag
import net.cyndeline.scalarlib.rlgraph.cycles.{Cycle, SingleCycleFinder, UndirectedSingleCycleFinder}
