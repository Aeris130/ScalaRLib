package net.cyndeline.scalarlib.rlgraph.cycles.directedCycles

import scalax.collection.GraphEdge.DiEdge
import scalax.collection.immutable.Graph
import net.cyndeline.scalarlib.rlgraph.cycles.{DirectedSimpleCycles, Cycle}
import scala.collection.mutable.ListBuffer
import net.cyndeline.scalarlib.rlgraph.util.{GraphCommons, IndexVertex, IndexGraph}
import scala.reflect.runtime.universe.TypeTag
import net.cyndeline.scalarlib.rlgraph.subgraph.stronglyConnectedComponents.TarjansAlgorithm
