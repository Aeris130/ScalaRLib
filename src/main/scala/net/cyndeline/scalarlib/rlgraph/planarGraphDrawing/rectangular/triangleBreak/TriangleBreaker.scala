package net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.rectangular.triangleBreak

import net.cyndeline.scalarlib.rlgraph.face.FaceComputation
import net.cyndeline.scalarlib.rlgraph.subgraph.triangles.TriangleFinder
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.rectangular.triangleBreak.help.BubbleGraph
import scala.collection.mutable.ListBuffer
import scala.reflect.runtime.universe.TypeTag
import scala.reflect.ClassTag
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.rectangular.dataStructure.RVertex
import net.cyndeline.scalarlib.rlgraph.embedding.{Vertex, Embedding}
