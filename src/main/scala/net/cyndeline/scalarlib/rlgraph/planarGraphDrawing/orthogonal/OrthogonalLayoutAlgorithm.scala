...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.representation._
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.constraints.{SegmentFactory, ShapeGraphFactory}
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.representation.help.darts.DartDirection._
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.constraints.help.Segment
import scalax.collection.edge.WLkDiEdge
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.network.DualMinimumCostFlow.DualMinimumCostFlow
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.representation.help.{VertexWrapperFactory, OrthogonalDartRep}
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.constraints.help.SegmentOrientation._
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.drawing.{DrawingFactory, OrthogonalLayout}
import scala.collection.mutable.ArrayBuffer
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.constraints.improvementHeuristic.VisibilityGraphFactory
import scala.reflect.runtime.universe._
import scala.reflect.ClassTag
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.operation.OrthoRepresentationComputation
