package net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.rectangular.help

import net.cyndeline.scalarlib.rlgraph.util.{GraphCommons, GraphConverter}
import scalax.collection.immutable.Graph
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.rectangular.dataStructure.RVertex
import scalax.collection.GraphEdge.UnDiEdge
import net.cyndeline.scalarlib.rlgraph.face.{FaceComputation, Face}
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.rectangular.triangleBreak.TriangleBreaker
import net.cyndeline.scalarlib.rlgraph.triangulation.fourConnectivity.FourConnectivityTriangulation
import scala.reflect.runtime.universe.TypeTag
import scala.reflect.ClassTag
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.rectangular.embedding.BhaskerSahniEmbedder
