package net.cyndeline.scalarlib.rlgraph.face

import scalax.collection.mutable.Graph
import scalax.collection.GraphEdge._
import scalax.collection.GraphPredef._
import net.cyndeline.scalarlib.rlgraph.planar.ComputeFaceOperation
import net.cyndeline.scalarlib.rlgraph.embedding.{AdjacencyList, Embedding}
