package net.cyndeline.scalarlib.rlgraph.canonicalOrder.planar4ConnectedTriangular

import net.cyndeline.scalarlib.rlgraph.embedding.{Embedding}
import scala.collection.mutable
import net.cyndeline.scalarlib.rlgraph.util.GraphCommons
import net.cyndeline.scalarlib.rlgraph.canonicalOrder.planar4ConnectedTriangular.help.VertexLabels
