package net.cyndeline.scalarlib.rlgraph.cartogram.rectangular.linearProgramming
...
import net.cyndeline.scalarlib.rlgraph.cartogram.rectangular.linearProgramming.linearSolver.{LinearChocoSolver, LinearSolver}
