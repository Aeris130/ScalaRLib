...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.rectangular.{RectangularLayout, RELDualAlgorithm}
import scalax.collection.GraphEdge.UnDiEdge
import net.cyndeline.scalarlib.rlgraph.cartogram.rectangular.common.MapArea
import net.cyndeline.scalarlib.rlgraph.regularEdgeLabeling.altFourCycles.{FourCycle, AlternatingFourCycles}
