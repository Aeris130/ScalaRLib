package net.cyndeline.scalarlib.rlgraph.embedding.immutable

import scala.collection.mutable
import net.cyndeline.scalarlib.rlgraph.embedding.{EdgeInsert, AdjacencyList, AdjacencyEntry, Embedding}
