...
import net.cyndeline.scalarlib.rlgraph.cartogram.rectangular.linearProgramming.LinearOptimization

@RunWith(classOf[JUnitRunner])
class LinearOptimizationSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
