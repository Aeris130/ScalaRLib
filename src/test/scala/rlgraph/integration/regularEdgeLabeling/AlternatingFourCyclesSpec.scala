...
import net.cyndeline.scalarlib.rlgraph.regularEdgeLabeling.altFourCycles.{EssentialFourCycle, AlternatingFourCycles}
import net.cyndeline.scalarlib.rlgraph.regularEdgeLabeling.{LabelEdge, EdgeLabeling}

@RunWith(classOf[JUnitRunner])
class AlternatingFourCyclesSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
