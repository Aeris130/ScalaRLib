package rlgraph.integration.rectangular

import org.junit.runner.RunWith
import org.scalatest.junit.JUnitRunner
import org.scalatest.{GivenWhenThen, FunSpec}
import org.scalatest.matchers.ShouldMatchers
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.rectangular.triangleBreak.help.{BubbleVertex, BubbleGraph}
import net.cyndeline.scalarlib.rlgraph.subgraph.triangles.Triangle
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.rectangular.triangleBreak.PruneMiniMax

@RunWith(classOf[JUnitRunner])
class PruneMiniMaxSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
