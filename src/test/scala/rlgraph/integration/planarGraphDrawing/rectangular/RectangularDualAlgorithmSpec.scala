...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.rectangular.{RAlgorithmSettings, OuterFaceSelection, RectangularLayout, RectangularDualAlgorithm}
import scalax.collection.GraphEdge.UnDiEdge
import net.cyndeline.scalarlib.rlgraph.face.Face
import net.cyndeline.scalarlib.rldrawing.util.{Point, Intersection}
import net.cyndeline.scalarlib.rlgraph.util.GraphCommons
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.rectangular.dataStructure.{RVertex, Rectangle}
import net.cyndeline.scalarlib.rlgraph.embedding.immutable.UndirectedEmbedding
import net.cyndeline.scalarlib.rlgraph.embedding.{Embedding, Vertex}
import net.cyndeline.scalarlib.rlgraph.regularEdgeLabeling.{RELFactory, RegularEdgeLabeling}
import org.scalamock.scalatest.MockFactory
import scala.reflect.runtime.universe.TypeTag
import scala.reflect.ClassTag
import net.cyndeline.scalarlib.rlgraph.regularEdgeLabeling.factories.CanonicalOrderFactory
import rlgraph.help.RLayoutValidation

@RunWith(classOf[JUnitRunner])
class RectangularDualAlgorithmSpec extends FunSpec with GivenWhenThen with ShouldMatchers with MockFactory {
