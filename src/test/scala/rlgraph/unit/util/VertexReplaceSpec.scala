...
import net.cyndeline.scalarlib.rlgraph.util.{EdgeCopyFactory, VertexReplacer, UndirectedEdgeFactory}
import scalax.collection.GraphEdge.{DiEdge, UnDiEdge}
import scalax.collection.immutable.Graph
import scalax.collection.GraphPredef._

@RunWith(classOf[JUnitRunner])
class VertexReplaceSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
