...
import net.cyndeline.scalarlib.rlgraph.cartogram.rectangular.linearProgramming.linearSolver.LinearChocoSolver

@RunWith(classOf[JUnitRunner])
class LinearChocoSolverSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
