...
import net.cyndeline.scalarlib.rlgraph.cartogram.rectangular.common.SegmentMap
import scalax.collection.immutable.Graph

@RunWith(classOf[JUnitRunner])
class SegmentMapSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
