...
import net.cyndeline.scalarlib.rlgraph.cartogram.rectangular.segmentHeuristic.help.{ValidMovement, SegmentEntry}
import net.cyndeline.scalarlib.rlgraph.cartogram.rectangular.segmentHeuristic.help.MoveDir._

@RunWith(classOf[JUnitRunner])
class ValidMovementSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
