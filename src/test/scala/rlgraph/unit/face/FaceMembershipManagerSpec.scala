...
import net.cyndeline.scalarlib.rlgraph.face.{FaceMembershipManager, Face}

@RunWith(classOf[JUnitRunner])
class FaceMembershipManagerSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
