...
import net.cyndeline.scalarlib.rlgraph.biconnectivity.biconnect.KantBodlaenderBiconnection.help.BiconnectedComponentMerger
import scalax.collection.immutable.Graph
import scalax.collection.GraphPredef._

@RunWith(classOf[JUnitRunner])
class BiconnectedComponentMergerSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
