...
import net.cyndeline.scalarlib.rlgraph.biconnectivity.biconnect.KantBodlaenderBiconnection.help.AdjacencyOrdering

@RunWith(classOf[JUnitRunner])
class AdjacencyOrderingSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
