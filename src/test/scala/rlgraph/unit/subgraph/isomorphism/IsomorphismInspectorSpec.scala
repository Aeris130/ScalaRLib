...
import net.cyndeline.scalarlib.rlgraph.subgraph.isomorphism.util.DefaultVertexEquivalence
import scalax.collection.immutable.Graph
import scalax.collection.GraphPredef._
import net.cyndeline.scalarlib.rlgraph.subgraph.isomorphism.NegativeCondition
import scalax.collection.GraphEdge.UnDiEdge
import net.cyndeline.scalarlib.rlgraph.subgraph.isomorphism.jGraphT.IsomorphismInspector

@RunWith(classOf[JUnitRunner])
class IsomorphismInspectorSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
