...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.rectangular.help.OuterFaceAugmentation
...
class OuterFaceAugmentationSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
