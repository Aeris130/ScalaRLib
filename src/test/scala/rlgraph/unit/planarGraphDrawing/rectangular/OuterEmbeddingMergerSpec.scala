...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.rectangular.embedding.help.OuterEmbeddingMerger
...
class OuterEmbeddingMergerSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
