...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.rectangular.embedding.help.CommonVertexFinder

@RunWith(classOf[JUnitRunner])
class CommonVertexFinderSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
