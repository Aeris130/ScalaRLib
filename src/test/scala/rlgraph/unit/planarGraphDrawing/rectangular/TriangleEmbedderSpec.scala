...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.rectangular.embedding.help.TriangleEmbedder
import net.cyndeline.scalarlib.rlgraph.embedding.immutable.UndirectedEmbedding

@RunWith(classOf[JUnitRunner])
class TriangleEmbedderSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
