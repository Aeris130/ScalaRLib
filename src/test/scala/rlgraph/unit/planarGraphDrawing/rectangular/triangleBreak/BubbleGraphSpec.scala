...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.rectangular.triangleBreak.help.{BubbleGraph, Bubble}

@RunWith(classOf[JUnitRunner])
class BubbleGraphSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
