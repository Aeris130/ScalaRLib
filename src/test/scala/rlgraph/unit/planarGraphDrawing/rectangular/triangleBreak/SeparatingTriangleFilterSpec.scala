...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.rectangular.triangleBreak.SeparatingTriangleFilter
import net.cyndeline.scalarlib.rlgraph.util.IndexVertex

@RunWith(classOf[JUnitRunner])
class SeparatingTriangleFilterSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
