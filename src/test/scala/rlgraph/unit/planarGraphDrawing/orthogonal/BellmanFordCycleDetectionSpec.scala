...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.network.BellmanFordCycleDetection
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.network.util.FlowVertex

@RunWith(classOf[JUnitRunner])
class BellmanFordCycleDetectionSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
