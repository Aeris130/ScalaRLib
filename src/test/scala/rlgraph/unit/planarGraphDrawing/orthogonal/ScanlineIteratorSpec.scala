...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.representation.help.VertexWrapper
...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.constraints.improvementHeuristic.CornerType._
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.constraints.improvementHeuristic.{ScanlineIterator, SegmentCorner}
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.constraints.help.Segment

@RunWith(classOf[JUnitRunner])
class ScanlineIteratorSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
