...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.representation.help.{VertexWrapperFactory, OFace, OrthogonalDartRep, VertexWrapper}
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.representation.OrthogonalFaceSimplifier
...
class OrthogonalFaceSimplifierSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
