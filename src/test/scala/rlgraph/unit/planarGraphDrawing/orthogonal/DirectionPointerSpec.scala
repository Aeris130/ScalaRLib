...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.representation.DirectionPointer
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.representation.help.{OrthogonalDartRep, Dart, OFace, VertexWrapper}
...
class DirectionPointerSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
