...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.constraints.SegmentFactory
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.constraints.help.Segment

@RunWith(classOf[JUnitRunner])
class SegmentFactorySpec extends FunSpec with GivenWhenThen with ShouldMatchers {
