...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.network.util.{FlowVertexReplacer, FlowEdgeAssoc, FlowVertex}
import scalax.collection.immutable.Graph
import scalax.collection.GraphEdge.DiEdge
import scalax.collection.GraphPredef._

@RunWith(classOf[JUnitRunner])
class FlowVertexReplacerSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
