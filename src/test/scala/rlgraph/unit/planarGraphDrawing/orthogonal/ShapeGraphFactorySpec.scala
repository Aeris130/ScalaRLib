...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.representation.help.{Dart, VertexWrapper}
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.constraints.help.SegmentOrientation
import SegmentOrientation._
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.representation.help.darts.DefaultDart
...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.constraints.ShapeGraphFactory
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.constraints.help.Segment

@RunWith(classOf[JUnitRunner])
class ShapeGraphFactorySpec extends FunSpec with GivenWhenThen with ShouldMatchers {
