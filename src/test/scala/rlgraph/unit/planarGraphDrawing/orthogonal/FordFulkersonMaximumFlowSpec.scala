...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.network.MaxFlowMinCost.FordFulkersonMaximumFlow

@RunWith(classOf[JUnitRunner])
class FordFulkersonMaximumFlowSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
