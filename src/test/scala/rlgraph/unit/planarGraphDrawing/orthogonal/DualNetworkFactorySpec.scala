...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.network.DualMinimumCostFlow.DualNetworkFactory
...
class DualNetworkFactorySpec extends FunSpec with GivenWhenThen with ShouldMatchers {
