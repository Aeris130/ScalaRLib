...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.representation.ArtificialRemover
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.representation.help.darts.{SimpleDart, SplitDart, ArtificialDart, DefaultDart}
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.representation.help.{Dart, VertexWrapper}

@RunWith(classOf[JUnitRunner])
class ArtificialRemoverSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
