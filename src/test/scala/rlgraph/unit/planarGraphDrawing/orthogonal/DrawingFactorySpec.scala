...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.representation.help.darts.{SimpleDart, DefaultDart}
...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.drawing.DrawingFactory
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.representation.help.{VertexWrapperFactory, Dart, VertexWrapper}
...
class DrawingFactorySpec extends FunSpec with GivenWhenThen with ShouldMatchers {
