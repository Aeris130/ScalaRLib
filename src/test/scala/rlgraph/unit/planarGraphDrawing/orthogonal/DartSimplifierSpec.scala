...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.representation.help.{VertexWrapperFactory, VertexWrapper}
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.representation.DartSimplifier
...
class DartSimplifierSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
