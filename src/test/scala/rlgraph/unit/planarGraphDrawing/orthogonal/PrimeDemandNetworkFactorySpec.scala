...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.network.util.{FlowEdgeAssoc, FlowVertex}
...
class PrimeDemandNetworkFactorySpec extends FunSpec with GivenWhenThen with ShouldMatchers {
