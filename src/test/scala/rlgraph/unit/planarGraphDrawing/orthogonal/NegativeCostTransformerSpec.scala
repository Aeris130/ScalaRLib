...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.network.NegativeCostTransformer

@RunWith(classOf[JUnitRunner])
class NegativeCostTransformerSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
