...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.network.util.{NetworkRepresentation, FlowEdgeAssoc, FlowVertex}
...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.representation.help.{VertexWrapperFactory, VertexWrapper, OFace, Dart}

@RunWith(classOf[JUnitRunner])
class OrthogonalFaceFactorySpec extends FunSpec with GivenWhenThen with ShouldMatchers {
