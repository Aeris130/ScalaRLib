...
import net.cyndeline.scalarlib.rlgraph.planarGraphDrawing.orthogonal.network.util.{FlowEdge, FlowVertex, NetworkRepresentation}
...
class FlowNetworkConstructorSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
