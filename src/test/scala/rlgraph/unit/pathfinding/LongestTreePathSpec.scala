...
import net.cyndeline.scalarlib.rlgraph.pathfinding.{Path, LongestTreePath}
import scalax.collection.GraphEdge.UnDiEdge

@RunWith(classOf[JUnitRunner])
class LongestTreePathSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
