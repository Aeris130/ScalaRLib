...
import net.cyndeline.scalarlib.rlgraph.triangulation.minimumDegree.faceTriangulation.multiEdgePrevention.help.VisitedVertex
import rlgraph.help.CycleOrderMatcher
import scalax.collection.GraphEdge.UnDiEdge
import org.scalamock.scalatest.MockFactory
import net.cyndeline.scalarlib.rlgraph.cycles.{Cycle, SingleCycleFinder}
import net.cyndeline.scalarlib.rlgraph.util.{GraphConverterI, GraphConverter}
import scala.reflect.runtime.universe.TypeTag
import net.cyndeline.scalarlib.rlgraph.pathfinding.disjointElementaryCycle.help.ElementaryCycleFinder

@RunWith(classOf[JUnitRunner])
class ElementaryCycleFinderSpec extends FunSpec with GivenWhenThen with ShouldMatchers with MockFactory {
