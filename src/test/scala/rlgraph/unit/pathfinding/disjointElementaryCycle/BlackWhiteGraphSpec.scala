...
import net.cyndeline.scalarlib.rlgraph.pathfinding.disjointElementaryCycle.BlackWhiteGraph
import net.cyndeline.scalarlib.rlgraph.embedding.immutable.UndirectedEmbedding

@RunWith(classOf[JUnitRunner])
class BlackWhiteGraphSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
