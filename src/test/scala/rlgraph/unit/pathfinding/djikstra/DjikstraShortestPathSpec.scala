...
import net.cyndeline.scalarlib.rlgraph.pathfinding.djikstra.DjikstraShortestPath
import scalax.collection.GraphEdge.UnDiEdge

@RunWith(classOf[JUnitRunner])
class DjikstraShortestPathSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
