...
import net.cyndeline.scalarlib.rlgraph.cycles.directedCycles.JohnsonSimpleCycles
import net.cyndeline.scalarlib.rlgraph.cycles.Cycle
import scalax.collection.GraphEdge.DiEdge

@RunWith(classOf[JUnitRunner])
class JohnsonSimpleCyclesSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
