...
import net.cyndeline.scalarlib.rlgraph.cycles.UndirectedSingleCycleFinder
...
class UndirectedSingleCycleFinderSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
