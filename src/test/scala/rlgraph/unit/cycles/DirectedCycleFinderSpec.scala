...
import net.cyndeline.scalarlib.rlgraph.cycles.{Cycle, DirectedCycleFinder}
import scalax.collection.GraphEdge.DiEdge

@RunWith(classOf[JUnitRunner])
class DirectedCycleFinderSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
