...
import net.cyndeline.scalarlib.rlgraph.regularEdgeLabeling.altFourCycles.CycleVerifier
...
class CycleVerifierSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
