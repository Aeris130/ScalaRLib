...
import net.cyndeline.scalarlib.rlgraph.regularEdgeLabeling.altFourCycles.EssentialFourCycle
import net.cyndeline.scalarlib.rlgraph.regularEdgeLabeling.angularMap.AngularMap
import net.cyndeline.scalarlib.rlgraph.regularEdgeLabeling.{EdgeLabeling, LabelEdge}

@RunWith(classOf[JUnitRunner])
class EssentialFourCycleSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
