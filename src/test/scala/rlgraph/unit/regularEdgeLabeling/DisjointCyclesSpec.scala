...
import net.cyndeline.scalarlib.rlgraph.regularEdgeLabeling.angularMap.AngularVertex
import net.cyndeline.scalarlib.rlgraph.cycles.Cycle
import net.cyndeline.scalarlib.rlgraph.regularEdgeLabeling.altFourCycles.{EdgeData, DisjointCycles}
import net.cyndeline.scalarlib.rlgraph.regularEdgeLabeling.LabelEdge

@RunWith(classOf[JUnitRunner])
class DisjointCyclesSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
