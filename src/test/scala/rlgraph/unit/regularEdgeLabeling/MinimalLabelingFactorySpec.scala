...
import net.cyndeline.scalarlib.rlgraph.regularEdgeLabeling.factories.MinimalLabelingFactory
import net.cyndeline.scalarlib.rlgraph.regularEdgeLabeling.LabelEdge

@RunWith(classOf[JUnitRunner])
class MinimalLabelingFactorySpec extends FunSpec with GivenWhenThen with ShouldMatchers {
