...
import net.cyndeline.scalarlib.rlgraph.regularEdgeLabeling.{LabelEdge, RegularEdgeLabeling}
...
import rlgraph.help.{RegularEdgeLabelingData, CycleOrderMatcher}

@RunWith(classOf[JUnitRunner])
class RegularEdgeLabelingSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
