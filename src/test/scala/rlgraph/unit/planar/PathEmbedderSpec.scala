...
import net.cyndeline.scalarlib.rlgraph.planar.demoucron.operation.help.PathEmbedder
...
import net.cyndeline.scalarlib.rlgraph.pathfinding.BFSPathfinder

@RunWith(classOf[JUnitRunner])
class PathEmbedderSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
