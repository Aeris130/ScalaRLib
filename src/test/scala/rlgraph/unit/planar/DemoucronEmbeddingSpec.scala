...
import net.cyndeline.scalarlib.rlgraph.embedding.{AdjacencyEntry, AdjacencyList}

@RunWith(classOf[JUnitRunner])
class DemoucronEmbeddingSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
