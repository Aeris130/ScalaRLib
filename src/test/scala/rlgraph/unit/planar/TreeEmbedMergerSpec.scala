...
import net.cyndeline.scalarlib.rlgraph.planar.demoucron.operation.help.TreeEmbedMerger
import scalax.collection.GraphEdge.UnDiEdge
import net.cyndeline.scalarlib.rlgraph.embedding.immutable.UndirectedEmbedding
import scalax.collection.immutable.Graph
import scalax.collection.GraphPredef._
import net.cyndeline.scalarlib.rlgraph.embedding.{AdjacencyEntry, AdjacencyList, Embedding}

@RunWith(classOf[JUnitRunner])
class TreeEmbedMergerSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
