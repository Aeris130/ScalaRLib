...
import net.cyndeline.scalarlib.rlgraph.embedding.{Vertex, AdjacencyList, AdjacencyEntry}
...
class UndirectedEmbeddingSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
