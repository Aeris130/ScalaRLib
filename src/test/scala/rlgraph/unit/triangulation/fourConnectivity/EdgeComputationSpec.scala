...
import net.cyndeline.scalarlib.rlgraph.triangulation.fourConnectivity.help.EdgeComputation
...
class EdgeComputationSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
