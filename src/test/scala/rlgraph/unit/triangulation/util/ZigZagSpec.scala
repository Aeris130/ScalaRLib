...
import java.lang.{IllegalArgumentException, Error}
import net.cyndeline.scalarlib.rlgraph.triangulation.util.ZigZag

@RunWith(classOf[JUnitRunner])
class ZigZagSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
