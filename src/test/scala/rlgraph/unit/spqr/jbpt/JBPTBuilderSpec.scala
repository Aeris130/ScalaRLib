...
import net.cyndeline.scalarlib.rlgraph.spqr.jbpt.{OrderedEdge, JBPTBuilder}
import net.cyndeline.scalarlib.rlgraph.spqr.{SPQRTree, Parallel, Rigid, Edge}
import scalax.collection.GraphEdge.UnDiEdge
import net.cyndeline.scalarlib.util.UnorderedPair

@RunWith(classOf[JUnitRunner])
class JBPTBuilderSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
