...
import net.cyndeline.scalarlib.rlgraph.spqr.jbpt.{JBPTTree, HashNode}
import net.cyndeline.scalarlib.rlgraph.spqr.SPQRNode

@RunWith(classOf[JUnitRunner])
class JBPTTreeSpec extends FunSpec with GivenWhenThen with ShouldMatchers {
